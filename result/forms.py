...
class HPVInfoForm(forms.ModelForm):
    ...
    test_kit = forms.ChoiceField(choices = [('KT','KHOA THƯƠNG'),('KT_611','KHOA THƯƠNG + 6/11'),('VA', 'VIỆT Á')], label = 'Loại kit')
...
class HPVSampleForm(forms.ModelForm):
    ...
    result_6_kt = forms.ChoiceField(choices=(("",""),('DƯƠNG TÍNH','DƯƠNG TÍNH'),('ÂM TÍNH', 'ÂM TÍNH')), label = 'HPV 6', required = False)
    result_11_kt = forms.ChoiceField(choices=(("",""),('DƯƠNG TÍNH','DƯƠNG TÍNH'),('ÂM TÍNH', 'ÂM TÍNH')), label = 'HPV 11', required = False)
    sample_type = forms.ChoiceField(choices = [('Phết cổ tử cung','Phết cổ tử cung' ), ('Phết vòm họng', 'Phết vòm họng'), ('Phết niệu đạo', 'Phết niệu đạo'), ('Phết âm đạo','Phết âm đạo'), ('Mẫu phết', 'Mẫu phết') , ('Khác', 'Khác')], label = 'Loại mẫu')
